...
<style>
  ...
  .pay-btn--closed:hover {
    border-color: #ccc;
    background: #f5f5f5;
    transform: none;
  }

  .pay-btn--closed .btn-main {
    color: #999;
  }

  .pay-btn--closed .pay-btn-price {
    color: #999;
  }
  ...
  <div class="content-container">
    ...
    <section class="detail-section js-anim-section">
      ...
      <div class="price-grid js-anim-item">
        ...
        <div class="price-card">
          ...
          <span class="btn-plan btn-plan--closed">申込期限が終了しました。</span>
        </div>
        ...
        <div class="price-card retake">
          ...
          <div class="retake-right">
            ...
            <div class="retake-buttons">
              <span class="btn-simple btn-simple--closed">申込期限が終了しました。</span>
              <span class="btn-simple btn-simple--closed">申込期限が終了しました。</span>
            </div>
          </div>
        </div>
    ...
    <section id="payment" class="cta-area js-anim-section">
      ...
      <div class="payment-buttons js-anim-item">
        ...
        <span class="pay-btn pay-btn--closed">
          <div class="pay-btn-info">
            <span class="btn-main">多次元統合療法 ベーシックコース(全5日間)<br>に申し込む</span>
            <span class="pay-btn-closed-msg">申込期限が終了しました。</span>
          </div>
